...
export default function Login() {
  ...
  return (
    <main className="flex h-screen flex-col items-center justify-between bg-[#D7EDFF]">
      <section className="flex h-full w-full p-5 gap-5">
        <div className="w-1/2 h-full">
          <Onboarding />
        </div>
        <div className="bg-white h-full  grid place-content-center w-1/2 rounded-2xl" >
          <form
          ...
          <div className=" flex h-[4rem] w-full flex-col items-end justify-center px-10 text-sm text-white">
            <div>{version && <p>v{version}</p>}</div>
            <div className="flex items-center gap-2 font-medium">
              <p className="text-black/50">A Product of</p>
