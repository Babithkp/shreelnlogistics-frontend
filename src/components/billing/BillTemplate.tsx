    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.detailsRow}>
        <View style={[styles.detailsColumn, { gap: 5 }]}>
          ...
          <View style={{ flexDirection: "row" }}>
            <Text style={[styles.label, { width: "11rem" }]}>Client GSTIN</Text>
        ...
        <View style={{ width: "30%", gap: 3 }}>
          ...
          <View style={{ flexDirection: "row" }}>
            <Text style={[styles.label, { width: "8rem" }]}>Service Type</Text>
            <Text>: By Road</Text>
          </View>
          <View style={{ flexDirection: "row" }}>
            <Text style={[styles.label, { width: "8rem" }]}>
      ...
      <View style={styles.remarks}>
        ...
        <View>
          <Text style={{ fontSize: 8, lineHeight: 1.3 }}>
            ...
            (3) of Section 9 of CGST Act, 2017 and in case of Inter state supply
            of Service, liability to pay GST is of Recipient of Service under
            Reverse Charge as per Serial No 2 of Notification No 10/2017 dated
            20.06.2017 issued under Sub Section (3) of Section 5
            of IGST Act, 2017
          </Text>
        </View>
      </View>
